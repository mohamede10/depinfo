    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto py-0">
            ...
            <div class="dropdown-menu m-0">
                    ...
                    <a href="verifcon.php" class="dropdown-item">Mon compte</a>
            </div>
...
Les étudiants sont également encouragés à participer à des compétitions technologiques, des hackathons, et à mener des projets de recherche.</p>
        ...
        <div class="col-md-6 wow slideInUp" data-wow-delay="0.1s">
                            <div class="blog-item bg-light rounded overflow-hidden">
                                <div class="blog-img position-relative overflow-hidden">
                                    ...
                                    <a class="position-absolute top-0 start-0 bg-primary text-white rounded-end mt-5 py-2 px-4" href="">La Technologie</a>
                                </div>
                                <div class="p-4">
                                    ...
                                    <h4 class="mb-3">Le monde informatique</h4>
                                    <p>Suivez les actualités sur la technologie</p>
                                    <a class="text-uppercase" href="https://www.lemondeinformatique.fr/">Plus... <i class="bi bi-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
    ...
    <!-- About End -->
     <div class="col-6 container-fluid row ">
        <div class="col-6">
             <a href="professeurs.php" > <button style="border-radius: 5px;" class="btn-primary"> Suivez vos professeurs ici...</button> </a>
        <br> <br> <br>
        </div>    
