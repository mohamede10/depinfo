            ...
            <div class="nav-item dropdown">
                 <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown">A propos</a>
                    <div class="dropdown-menu m-0">
                        ...
                        <a href="personnages.php" class="dropdown-item active" >Personnages</a>
    ...
    <div class="container-fluid bg-primary py-5 mb-5">
        <div class="row py-3">
            <div class="col-12 text-center">
                <h1 class="display-3 text-white animated zoomIn">UNVIERSITE DE LABE </h1>
                <a href="" class="h4 text-white">DISPLINE</a>
                <i class="far fa-circle text-white px-2"></i>
                <a href="" class="h4 text-white">RIGEUR</a>
            </div>
        </div>
    </div>
    <!-- Hero End -->
        ...
        <div class="container">
            ...
            <div class="col-lg-4 wow slideInUp" data-wow-delay="0.1s">
                    <div class="section-title bg-light rounded h-100 p-5">
                        <h5 class="position-relative d-inline-block text-primary text-uppercase">Univ-LABE</h5>
                        <h1 class="display-6 mb-4">Rectorat</h1>
                        <a href="appointment.html" class="btn btn-primary py-3 px-5">Savoir plus...</a>
                    </div>
                </div>
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                    <div class="team-item">
                        ...
                        <div class="team-text position-relative bg-light text-center rounded-bottom p-4 pt-5">
                            <h4 class="mb-2">Dr. Mohamed Cherif SOW</h4>
                            <p class="text-primary mb-0">Recteur de l'Université de Labe</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.6s">
                    <div class="team-item">
                        ...
                        <div class="team-text position-relative bg-light text-center rounded-bottom p-4 pt-5">
                            <h4 class="mb-2">M. Mohamed KCAMARA</h4>
                            <p class="text-primary mb-0">Vice Recteur de l'Université</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.1s">
                    <div class="section-title bg-light rounded h-100 p-5">
                        <h5 class="position-relative d-inline-block text-primary text-uppercase">Département</h5>
                        <h2 class=" mb-4">INFORMATIQUE</h2>
                        <h6>La lumière de technologie informatique des université</h6>
                        <a href="appointment.html" class="btn btn-primary py-3 px-5">Savoir plus</a>
                    </div>
                </div>
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                    <div class="team-item">
                        ...
                        <div class="team-text position-relative bg-light text-center rounded-bottom p-4 pt-5">
                            <h4 class="mb-2">M. Aboudoulaye SOW</h4>
                            <p class="text-primary mb-0">Chef de Département Informatique</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.6s">
                    <div class="team-item">
                        ...
                        <div class="team-text position-relative bg-light text-center rounded-bottom p-4 pt-5">
                            <h4 class="mb-2">M. Koliko DELEMOU</h4>
                            <p class="text-primary mb-0">Chef de Programmes </p>
                        </div>
                    </div>
                </div>
                <br>
            <div class="row g-5">
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        ...
                        <div class="team-text position-relative bg-light text-center rounded-bottom p-4 pt-5">
                            <h4 class="mb-2">Dr. John DELEMOU</h4>
