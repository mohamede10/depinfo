            ...
            <div class="nav-item dropdown">
                 <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown">A propos</a>
                    <div class="dropdown-menu m-0">
                        ...
                        <a href="contact.php" class="dropdown-item active">Contact</a>
                    </div>
            </div>
    ...
    <div class="container-fluid bg-primary py-5 mb-5">
        <div class="row py-3">
            <div class="col-12 text-center">
                <h1 class="display-3 text-white animated zoomIn">Nous joindre 7/7</h1>
           
                <a href="" class="h4 text-white">Disponibilité</a>
                <i class="far fa-circle text-white px-2"></i>
                <a href="" class="h4 text-white">Satisfaction</a>
            </div>
        </div>
    </div>
    <!-- Hero End -->
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="row g-5">
                <div class="col-xl-4 col-lg-6 wow slideInUp" data-wow-delay="0.1s">
                    <div class="bg-light rounded h-100 p-5">
                        <div class="section-title">
                            <h5 class="position-relative d-inline-block text-primary text-uppercase">Contact-nous</h5>
                            <h1 class="display-6 mb-4">Localisation</h1>
                        </div>
                        <div class="d-flex align-items-center mb-2">
                            <i class="bi bi-geo-alt fs-1 text-primary me-3"></i>
                            <div class="text-start">
                                <h5 class="mb-0">Bureau</h5>
                                <span>Labé/Hafia/Université</span>
                            </div>
                        </div>
                        <div class="d-flex align-items-center mb-2">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="text-start">
                                <h5 class="mb-0">Appellez nous</h5>
                                <span>+224 622 294 367</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 wow slideInUp" data-wow-delay="0.3s">
                    <form>
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <textarea class="form-control border-0 bg-light px-4 py-3" rows="5" placeholder="Rediger votre message..."></textarea>
                            </div>
                            <div class="col-12">
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d13060.900460836743!2d-12.2891314!3d11.3232042!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xefc3b60ffe25911%3A0x9b6a8eea5ce8636a!2zVW5pdmVyc2l0w6kgZGUgTGFiw6k!5e1!3m2!1sfr!2s!4v1729264258709!5m2!1sfr!2s" width="400" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade">
                </iframe>
                </div>
            </div>
        </div>
